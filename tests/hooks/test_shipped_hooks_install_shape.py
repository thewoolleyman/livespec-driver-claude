...
_DENY_COMMANDS = (
    ...
    "pkill -f tmux",
    "killall tmux",
    # Evasion families that each shipped as a COMPLETE bypass of the packaged
    # guard. `tests/hooks/test_tmux_hazard.py` pins them against the classifier
    # in-process; these re-run them against the PACKAGED subtree under a bare
    # interpreter, which is how the guard actually runs.
